...
BEGIN
    ...
    SELECT MAX(polygon_id) INTO max_polygon_id FROM spt.polygon_test;
...
BEGIN
    ...
    IF OLD is distinct from NEW AND TG_OP != 'DELETE' THEN
        ...
        IF _json_diff is not null or TG_OP = 'INSERT' THEN
...
BEGIN
	...
	LOOP
    	...
    	IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = p_user_name) THEN
			...
			p_password := '';
		ELSE
			--random generate the password, set the length to 36?
...
CREATE FUNCTION public.invoices_update_ledger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
...
CREATE FUNCTION spt.update_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
    new.updated_at = now();
...
CREATE FUNCTION street_smarts.update_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
    new.updated_at = now();
...
COMMENT ON COLUMN alterra_production.ecosure_contacts.first_name IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.last_name IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.mobile2 IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.emergency_contact_name IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.emergency_phone_number IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.address1 IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.address2 IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.permanent_address IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.permanent_city IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.permanent_state IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.permanent_country IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.permanent_zip IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.spouse_name IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.spouse_last_name IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.age IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.ethnicity IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.gender IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.drivers_license_number IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.drivers_license_expiration_date IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.ss IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.state_license_number IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.state_license_expiration_date IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_contacts.is_us_citizen IS '{"is_pii":true}';
...
COMMENT ON COLUMN alterra_production.ecosure_office_branches.name IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_office_branches.address IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_office_branches.street_address_1 IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_office_branches.street_address_2 IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_office_branches.lat IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_office_branches.long IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_office_branches.license_number IS '{"is_pii":true}';
...
COMMENT ON COLUMN alterra_production.ecosure_offices.name IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_offices.latitude IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_offices.longitude IS '{"is_pii":true}';
...
COMMENT ON COLUMN alterra_production.ecosure_recruiting_seasons.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN alterra_production.ecosure_seasons.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN alterra_production.ecosure_users.license_number IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_users.passport_img IS '{"is_pii":true}';

COMMENT ON COLUMN alterra_production.ecosure_users.ssn_img IS '{"is_pii":true}';

CREATE TABLE audit.auth__api_account_roles (
...
CREATE TABLE audit.field_operations__route_actual_stats (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    table_id integer NOT NULL,
    operation text,
    row_old jsonb,
...
CREATE TABLE audit.field_operations__service_actual_stats (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    table_id integer NOT NULL,
    operation text,
    row_old jsonb,
...
CREATE TABLE audit.organization__api_accounts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    table_id uuid NOT NULL,
    operation text,
    row_old jsonb,
...
ALTER TABLE auth.user_roles ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE billing.payment_methods (
    ...
    pestroutes_payment_method_link jsonb
);
...
ALTER TABLE customer.cancellation_reasons ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE customer.note_types ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
COMMENT ON COLUMN field_operations.appointment_statuses.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN field_operations.appointment_types.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN field_operations.areas.name IS '{"is_pii":true}';

COMMENT ON COLUMN field_operations.areas.license_number IS '{"is_pii":true}';

COMMENT ON COLUMN field_operations.areas.address IS '{"is_pii":true}';

COMMENT ON COLUMN field_operations.areas.phone IS '{"is_pii":true}';

ALTER TABLE field_operations.areas ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
COMMENT ON COLUMN field_operations.failure_notification_recipients.name IS '{"is_pii":true}';

COMMENT ON COLUMN field_operations.failure_notification_recipients.phone IS '{"is_pii":true}';
...
COMMENT ON COLUMN field_operations.markets.name IS '{"is_pii":true}';

ALTER TABLE field_operations.markets ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE field_operations.office_days_schedule (
    ...
    address jsonb,
    event_type character varying(16) DEFAULT 'meeting'::character varying NOT NULL,
    end_after character varying(16) DEFAULT 'date'::character varying NOT NULL,
    occurrences integer,
    repeat_every integer
);

COMMENT ON COLUMN field_operations.office_days_schedule.address IS '{"is_pii":true}';
...
COMMENT ON COLUMN field_operations.office_days_schedule_overrides.address IS '{"is_pii":true}';
...
COMMENT ON COLUMN field_operations.regions.name IS '{"is_pii":true}';

ALTER TABLE field_operations.regions ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
COMMENT ON COLUMN field_operations.route_groups.name IS '{"pestroutes_column_name": "groupTitle","is_pii":true}';

ALTER TABLE field_operations.route_groups ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
COMMENT ON COLUMN field_operations.route_templates.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN field_operations.routes.name IS '{"pestroutes_column_name": "name","is_pii":true}';
...
COMMENT ON COLUMN field_operations.service_types.name IS '{"is_pii":true}';

ALTER TABLE field_operations.service_types ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME field_operations.service_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
COMMENT ON COLUMN licensing.counties.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN licensing.municipalities.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN licensing.states.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN licensing.user_county_licenses.license_number IS '{"is_pii":true}';
...
COMMENT ON COLUMN licensing.user_municipality_licenses.license_number IS '{"is_pii":true}';
...
COMMENT ON COLUMN licensing.user_state_licenses.license_number IS '{"is_pii":true}';
...
ALTER TABLE organization.dealers ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE product.plans ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE public.s3_loads_log (
...
CREATE TABLE public.test_invoices (
    id uuid NOT NULL,
    external_ref_id integer,
    account_id uuid NOT NULL,
    subscription_id uuid,
...
CREATE TABLE public.zip_team_ids (
    zip text NOT NULL,
    team_id integer
);
...
ALTER TABLE sales.teams ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE sales.territories ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
COMMENT ON COLUMN spt.area_extended.qualified_addresses IS '{"is_pii":true}';
...
COMMENT ON COLUMN spt.cells.qualified_addresses IS '{"is_pii":true}';

CREATE TABLE spt.cells_2023_03_31 (
    area_id integer NOT NULL,
    resolution integer NOT NULL,
    total_addresses integer NOT NULL,
    qualified_addresses integer NOT NULL,
...
COMMENT ON COLUMN spt.cells_2023_03_31.qualified_addresses IS '{"is_pii":true}';
...
COMMENT ON COLUMN spt.cells_old.qualified_addresses IS '{"is_pii":true}';
...
COMMENT ON COLUMN spt.cluster.latitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.cluster.longitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.cluster.geolocation IS '{"is_pii":true}';

COMMENT ON COLUMN spt.cluster.qualified_addresses IS '{"is_pii":true}';
...
COMMENT ON COLUMN spt.personal_access_tokens.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN spt.polygon.center_latitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.polygon.center_longitude IS '{"is_pii":true}';

CREATE TABLE spt.polygon_2023_04_01 (
    polygon_id integer NOT NULL,
    boundary public.geometry(Polygon,4326) NOT NULL,
    team_id integer,
...
COMMENT ON COLUMN spt.polygon_2023_04_01.center_latitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.polygon_2023_04_01.center_longitude IS '{"is_pii":true}';
...
CREATE SEQUENCE spt.polygon_test_polygon_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE spt.polygon_test_polygon_id_seq OWNED BY spt.polygon_test.polygon_id;

CREATE TABLE spt.polygons_to_delete_2024_03_24 (
    id integer NOT NULL,
    created_by public.urn,
    updated_by public.urn,
    deleted_by public.urn,
...
COMMENT ON COLUMN spt.team_extended.latitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.team_extended.longitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.team_extended.qualified_addresses IS '{"is_pii":true}';

CREATE TABLE spt.team_extended_2023_04_02 (
    team_id integer NOT NULL,
    latitude numeric(17,14),
    longitude numeric(17,14),
    active_customers integer NOT NULL,
...
COMMENT ON COLUMN spt.team_extended_2023_04_02.latitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.team_extended_2023_04_02.longitude IS '{"is_pii":true}';

COMMENT ON COLUMN spt.team_extended_2023_04_02.qualified_addresses IS '{"is_pii":true}';
...
CREATE TABLE street_smarts.bridgetree_id_assocation (
    bridgetree_id bigint NOT NULL,
    jade_id bigint
);
...
CREATE TABLE street_smarts.deleted_pins_2024_03_25 (
    id bigint NOT NULL,
    address character varying(255),
    city character varying(255),
    state character varying(255),
...
CREATE TABLE street_smarts.knocks (
    id bigint DEFAULT nextval('street_smarts.knocks_id_seq'::regclass) NOT NULL,
    polygon_id integer,
    pin_id bigint,
    lat double precision,
...
COMMENT ON COLUMN street_smarts.knocks.lat IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.knocks.lon IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.knocks.rep_lat IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.knocks.rep_lon IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.knocks.address IS '{"is_pii":true}';
...
CREATE TABLE street_smarts.outcomes (
    id integer DEFAULT nextval('street_smarts.outcomes_id_seq'::regclass) NOT NULL,
    name character varying(255),
    is_final boolean,
...
COMMENT ON COLUMN street_smarts.outcomes.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN street_smarts.outcome.name IS '{"is_pii":true}';
...
COMMENT ON COLUMN street_smarts.pins_old.address IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pins_old.lat IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pins_old.lon IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pins_old.first_name IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pins_old.last_name IS '{"is_pii":true}';
...
COMMENT ON COLUMN street_smarts.pin.address IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pin.lat IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pin.lon IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pin.first_name IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pin.last_name IS '{"is_pii":true}';
...
CREATE TABLE street_smarts.pin_ids_to_update_2024_03_25 (
    id bigint NOT NULL,
    id_to_replace_with bigint,
    created_by public.urn,
    updated_by public.urn,
    deleted_by public.urn,
    created_at timestamp(6) with time zone DEFAULT now() NOT NULL,
...
COMMENT ON COLUMN street_smarts.pin_issues.address IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pin_issues.lat IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pin_issues.lon IS '{"is_pii":true}';
...
CREATE TABLE street_smarts.pin_notes (
    id bigint DEFAULT nextval('street_smarts.pin_notes_id_seq'::regclass) NOT NULL,
    pin_id bigint,
    user_id integer,
    season_id integer,
...
COMMENT ON COLUMN street_smarts.pins.address IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pins.lat IS '{"is_pii":true}';

COMMENT ON COLUMN street_smarts.pins.lon IS '{"is_pii":true}';
...
COMMENT ON COLUMN street_smarts.zips.qualified_addresses IS '{"is_pii":true}';

CREATE TABLE street_smarts.zips_2023_03_30 (
    zip character(5) NOT NULL,
    area_id integer,
    team_id integer,
    active_customers integer,
...
COMMENT ON COLUMN street_smarts.zips_2023_03_30.qualified_addresses IS '{"is_pii":true}';

CREATE TABLE street_smarts.zips_2023_03_31 (
    zip character(5) NOT NULL,
    area_id integer,
    team_id integer,
    active_customers integer,
...
COMMENT ON COLUMN street_smarts.zips_2023_03_31.qualified_addresses IS '{"is_pii":true}';

CREATE TABLE street_smarts.zips_2023_04_10 (
    zip character(5) NOT NULL,
    area_id integer,
    team_id integer,
    active_customers integer,
...
COMMENT ON COLUMN street_smarts.zips_2023_04_10.qualified_addresses IS '{"is_pii":true}';

CREATE TABLE street_smarts.zips_backup (
    zip character(5) NOT NULL,
    area_id integer,
    team_id integer,
    active_customers integer,
...
COMMENT ON COLUMN street_smarts.zips_backup.qualified_addresses IS '{"is_pii":true}';

CREATE TABLE street_smarts.zips_old (
    zip character(5) NOT NULL,
    area_id integer,
    team_id integer,
    active_customers integer,
...
COMMENT ON COLUMN street_smarts.zips_old.qualified_addresses IS '{"is_pii":true}';
...
ALTER TABLE ONLY spt.polygon_test ALTER COLUMN polygon_id SET DEFAULT nextval('spt.polygon_test_polygon_id_seq'::regclass);
...
ALTER TABLE ONLY audit.auth__api_account_roles
    ADD CONSTRAINT auth__api_account_roles_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY audit.field_operations__route_actual_stats
    ADD CONSTRAINT field_operations__route_actual_stats_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY audit.field_operations__service_actual_stats
    ADD CONSTRAINT field_operations__service_actual_stats_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY audit.organization__api_accounts
    ADD CONSTRAINT organization__api_accounts_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY crm.generic_flags
    ADD CONSTRAINT generic_flags_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.zip_team_ids
    ADD CONSTRAINT zip_team_ids_pkey PRIMARY KEY (zip);
...
ALTER TABLE ONLY spt.polygon_test
    ADD CONSTRAINT polygon_test_pkey PRIMARY KEY (polygon_id);

ALTER TABLE ONLY spt.polygons_to_delete_2024_03_24
    ADD CONSTRAINT polygons_to_delete_2024_03_24_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY street_smarts.bridgetree_id_assocation
    ADD CONSTRAINT bridgetree_id_assocation_pkey PRIMARY KEY (bridgetree_id);
...
ALTER TABLE ONLY street_smarts.pin_ids_to_update_2024_03_25
    ADD CONSTRAINT pin_ids_to_update_2024_03_25_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY street_smarts.pins
    ADD CONSTRAINT pins_unique_address_zip UNIQUE (address, zip);
...
ALTER TABLE ONLY street_smarts.zips_old
    ADD CONSTRAINT zips_pkey PRIMARY KEY (zip);
...
CREATE INDEX billing__failed_jobs_created_at_idx ON audit.billing__failed_jobs USING btree (created_at);

CREATE INDEX billing__failed_jobs_created_by_idx ON audit.billing__failed_jobs USING btree (created_by);

CREATE INDEX billing__failed_jobs_deleted_by_idx ON audit.billing__failed_jobs USING btree (deleted_by);

CREATE INDEX billing__failed_jobs_table_id_idx ON audit.billing__failed_jobs USING btree (table_id);

CREATE INDEX billing__failed_jobs_updated_at_idx ON audit.billing__failed_jobs USING btree (updated_at);

CREATE INDEX billing__failed_jobs_updated_by_idx ON audit.billing__failed_jobs USING btree (updated_by);

CREATE INDEX idx_auth__api_account_roles_created_at ON audit.auth__api_account_roles USING btree (created_at);

CREATE INDEX idx_auth__api_account_roles_created_by ON audit.auth__api_account_roles USING btree (created_by);

CREATE INDEX idx_auth__api_account_roles_deleted_by ON audit.auth__api_account_roles USING btree (deleted_by);

CREATE INDEX idx_auth__api_account_roles_pestroutes_sync_status_pending_only ON audit.auth__api_account_roles USING btree (pestroutes_sync_status) WHERE (pestroutes_sync_status = 'PENDING'::text);

CREATE INDEX idx_auth__api_account_roles_table_id ON audit.auth__api_account_roles USING btree (table_id);

CREATE INDEX idx_auth__api_account_roles_updated_at ON audit.auth__api_account_roles USING btree (updated_at);

CREATE INDEX idx_auth__api_account_roles_updated_by ON audit.auth__api_account_roles USING btree (updated_by);
...
CREATE INDEX idx_field_operations__route_actual_stats_created_at ON audit.field_operations__route_actual_stats USING btree (created_at);

CREATE INDEX idx_field_operations__route_actual_stats_created_by ON audit.field_operations__route_actual_stats USING btree (created_by);

CREATE INDEX idx_field_operations__route_actual_stats_deleted_by ON audit.field_operations__route_actual_stats USING btree (deleted_by);

CREATE INDEX idx_field_operations__route_actual_stats_pestroutes_sync_status ON audit.field_operations__route_actual_stats USING btree (pestroutes_sync_status) WHERE (pestroutes_sync_status = 'PENDING'::text);

CREATE INDEX idx_field_operations__route_actual_stats_table_id ON audit.field_operations__route_actual_stats USING btree (table_id);

CREATE INDEX idx_field_operations__route_actual_stats_updated_at ON audit.field_operations__route_actual_stats USING btree (updated_at);

CREATE INDEX idx_field_operations__route_actual_stats_updated_by ON audit.field_operations__route_actual_stats USING btree (updated_by);
...
CREATE INDEX idx_field_operations__service_actual_stats_created_at ON audit.field_operations__service_actual_stats USING btree (created_at);

CREATE INDEX idx_field_operations__service_actual_stats_created_by ON audit.field_operations__service_actual_stats USING btree (created_by);

CREATE INDEX idx_field_operations__service_actual_stats_deleted_by ON audit.field_operations__service_actual_stats USING btree (deleted_by);

CREATE INDEX idx_field_operations__service_actual_stats_pestroutes_sync_stat ON audit.field_operations__service_actual_stats USING btree (pestroutes_sync_status) WHERE (pestroutes_sync_status = 'PENDING'::text);

CREATE INDEX idx_field_operations__service_actual_stats_table_id ON audit.field_operations__service_actual_stats USING btree (table_id);

CREATE INDEX idx_field_operations__service_actual_stats_updated_at ON audit.field_operations__service_actual_stats USING btree (updated_at);

CREATE INDEX idx_field_operations__service_actual_stats_updated_by ON audit.field_operations__service_actual_stats USING btree (updated_by);
...
CREATE INDEX idx_organization__api_accounts_created_at ON audit.organization__api_accounts USING btree (created_at);

CREATE INDEX idx_organization__api_accounts_created_by ON audit.organization__api_accounts USING btree (created_by);

CREATE INDEX idx_organization__api_accounts_deleted_by ON audit.organization__api_accounts USING btree (deleted_by);

CREATE INDEX idx_organization__api_accounts_pestroutes_sync_status_pending_o ON audit.organization__api_accounts USING btree (pestroutes_sync_status) WHERE (pestroutes_sync_status = 'PENDING'::text);

CREATE INDEX idx_organization__api_accounts_table_id ON audit.organization__api_accounts USING btree (table_id);

CREATE INDEX idx_organization__api_accounts_updated_at ON audit.organization__api_accounts USING btree (updated_at);

CREATE INDEX idx_organization__api_accounts_updated_by ON audit.organization__api_accounts USING btree (updated_by);

CREATE INDEX api_account_roles_created_at_idx ON auth.api_account_roles USING btree (created_at);

CREATE INDEX api_account_roles_created_by_idx ON auth.api_account_roles USING btree (created_by);

CREATE INDEX api_account_roles_deleted_at_idx ON auth.api_account_roles USING btree (deleted_at);

CREATE INDEX api_account_roles_deleted_by_idx ON auth.api_account_roles USING btree (deleted_by);

CREATE INDEX api_account_roles_updated_at_idx ON auth.api_account_roles USING btree (updated_at);

CREATE INDEX api_account_roles_updated_by_idx ON auth.api_account_roles USING btree (updated_by);
...
CREATE INDEX appointments_account_id_index ON field_operations.appointments USING btree (account_id) WHERE (deleted_at IS NULL);
...
CREATE INDEX route_actual_stats_created_at_idx ON field_operations.route_actual_stats USING btree (created_at);

CREATE INDEX route_actual_stats_created_by_idx ON field_operations.route_actual_stats USING btree (created_by);

CREATE INDEX route_actual_stats_deleted_at_idx ON field_operations.route_actual_stats USING btree (deleted_at);

CREATE INDEX route_actual_stats_deleted_by_idx ON field_operations.route_actual_stats USING btree (deleted_by);

CREATE INDEX route_actual_stats_updated_at_idx ON field_operations.route_actual_stats USING btree (updated_at);

CREATE INDEX route_actual_stats_updated_by_idx ON field_operations.route_actual_stats USING btree (updated_by);
...
CREATE INDEX service_actual_stats_created_at_idx ON field_operations.service_actual_stats USING btree (created_at);

CREATE INDEX service_actual_stats_created_by_idx ON field_operations.service_actual_stats USING btree (created_by);

CREATE INDEX service_actual_stats_deleted_at_idx ON field_operations.service_actual_stats USING btree (deleted_at);

CREATE INDEX service_actual_stats_deleted_by_idx ON field_operations.service_actual_stats USING btree (deleted_by);

CREATE INDEX service_actual_stats_updated_at_idx ON field_operations.service_actual_stats USING btree (updated_at);

CREATE INDEX service_actual_stats_updated_by_idx ON field_operations.service_actual_stats USING btree (updated_by);
...
CREATE INDEX api_accounts_created_at_idx ON organization.api_accounts USING btree (created_at);

CREATE INDEX api_accounts_created_by_idx ON organization.api_accounts USING btree (created_by);

CREATE INDEX api_accounts_deleted_at_idx ON organization.api_accounts USING btree (deleted_at);

CREATE INDEX api_accounts_deleted_by_idx ON organization.api_accounts USING btree (deleted_by);

CREATE INDEX api_accounts_updated_at_idx ON organization.api_accounts USING btree (updated_at);

CREATE INDEX api_accounts_updated_by_idx ON organization.api_accounts USING btree (updated_by);
...
CREATE INDEX s3_loads_s3_key ON public.s3_loads_log USING btree (s3_key);

CREATE INDEX s3_loads_target_table ON public.s3_loads_log USING btree (target_table);
...
CREATE INDEX polygons_to_delete_2024_03_24_created_at_idx ON spt.polygons_to_delete_2024_03_24 USING btree (created_at);

CREATE INDEX polygons_to_delete_2024_03_24_created_by_idx ON spt.polygons_to_delete_2024_03_24 USING btree (created_by);

CREATE INDEX polygons_to_delete_2024_03_24_deleted_at_idx ON spt.polygons_to_delete_2024_03_24 USING btree (deleted_at);

CREATE INDEX polygons_to_delete_2024_03_24_deleted_by_idx ON spt.polygons_to_delete_2024_03_24 USING btree (deleted_by);

CREATE INDEX polygons_to_delete_2024_03_24_updated_at_idx ON spt.polygons_to_delete_2024_03_24 USING btree (updated_at);

CREATE INDEX polygons_to_delete_2024_03_24_updated_by_idx ON spt.polygons_to_delete_2024_03_24 USING btree (updated_by);
...
CREATE INDEX pin_ids_to_update_2024_03_25_created_at_idx ON street_smarts.pin_ids_to_update_2024_03_25 USING btree (created_at);

CREATE INDEX pin_ids_to_update_2024_03_25_created_by_idx ON street_smarts.pin_ids_to_update_2024_03_25 USING btree (created_by);

CREATE INDEX pin_ids_to_update_2024_03_25_deleted_at_idx ON street_smarts.pin_ids_to_update_2024_03_25 USING btree (deleted_at);

CREATE INDEX pin_ids_to_update_2024_03_25_deleted_by_idx ON street_smarts.pin_ids_to_update_2024_03_25 USING btree (deleted_by);

CREATE INDEX pin_ids_to_update_2024_03_25_updated_at_idx ON street_smarts.pin_ids_to_update_2024_03_25 USING btree (updated_at);

CREATE INDEX pin_ids_to_update_2024_03_25_updated_by_idx ON street_smarts.pin_ids_to_update_2024_03_25 USING btree (updated_by);
...
CREATE UNIQUE INDEX unique_pins_address_zip ON street_smarts.pins USING btree (address, zip) WHERE (deleted_at IS NULL);

CREATE INDEX zip_area_id ON street_smarts.zips_old USING btree (area_id);

CREATE INDEX zip_boundary ON street_smarts.zips_old USING gist (boundary);

CREATE INDEX zip_team_id ON street_smarts.zips_old USING btree (team_id);
...
CREATE TRIGGER api_account_roles_audit_record_trigger AFTER INSERT OR DELETE OR UPDATE ON auth.api_account_roles FOR EACH ROW EXECUTE FUNCTION public.create_audit_record();
...
CREATE TRIGGER api_account_roles_update_updated_at BEFORE UPDATE ON auth.api_account_roles FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
CREATE TRIGGER notes_after_insert_or_update_or_delete AFTER INSERT OR DELETE OR UPDATE ON customer.notes FOR EACH ROW EXECUTE FUNCTION public.create_audit_record();

CREATE TRIGGER notes_before_update BEFORE UPDATE ON customer.notes FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
CREATE TRIGGER route_actual_stats_audit_record_trigger AFTER INSERT OR DELETE OR UPDATE ON field_operations.route_actual_stats FOR EACH ROW EXECUTE FUNCTION public.create_audit_record();

CREATE TRIGGER route_actual_stats_update_updated_at BEFORE UPDATE ON field_operations.route_actual_stats FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
CREATE TRIGGER service_actual_stats_audit_record_trigger AFTER INSERT OR DELETE OR UPDATE ON field_operations.service_actual_stats FOR EACH ROW EXECUTE FUNCTION public.create_audit_record();

CREATE TRIGGER service_actual_stats_update_updated_at BEFORE UPDATE ON field_operations.service_actual_stats FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
CREATE TRIGGER notifications_sent_update_updated_at BEFORE UPDATE ON notifications.notifications_sent FOR EACH ROW EXECUTE FUNCTION notifications.update_updated_at();

CREATE TRIGGER api_accounts_audit_record_trigger AFTER INSERT OR DELETE OR UPDATE ON organization.api_accounts FOR EACH ROW EXECUTE FUNCTION public.create_audit_record();
...
CREATE TRIGGER api_accounts_update_updated_at BEFORE UPDATE ON organization.api_accounts FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
CREATE TRIGGER area_extended_update_updated_at BEFORE UPDATE ON spt.area_extended FOR EACH ROW EXECUTE FUNCTION spt.update_updated_at();

CREATE TRIGGER cluster_update_updated_at BEFORE UPDATE ON spt.cluster FOR EACH ROW EXECUTE FUNCTION spt.update_updated_at();

CREATE TRIGGER polygon_cluster_update_updated_at BEFORE UPDATE ON spt.polygon_cluster FOR EACH ROW EXECUTE FUNCTION spt.update_updated_at();

CREATE TRIGGER polygon_rep_update_updated_at BEFORE UPDATE ON spt.polygon_rep FOR EACH ROW EXECUTE FUNCTION spt.update_updated_at();

CREATE TRIGGER polygon_update_updated_at BEFORE UPDATE ON spt.polygon FOR EACH ROW EXECUTE FUNCTION spt.update_updated_at();

CREATE TRIGGER polygons_to_delete_2024_03_24_audit_record_trigger AFTER INSERT OR DELETE OR UPDATE ON spt.polygons_to_delete_2024_03_24 FOR EACH ROW EXECUTE FUNCTION public.create_audit_record();

ALTER TABLE spt.polygons_to_delete_2024_03_24 DISABLE TRIGGER polygons_to_delete_2024_03_24_audit_record_trigger;

CREATE TRIGGER polygons_to_delete_2024_03_24_update_updated_at BEFORE UPDATE ON spt.polygons_to_delete_2024_03_24 FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();

ALTER TABLE spt.polygons_to_delete_2024_03_24 DISABLE TRIGGER polygons_to_delete_2024_03_24_update_updated_at;

CREATE TRIGGER team_cluster_update_updated_at BEFORE UPDATE ON spt.team_cluster FOR EACH ROW EXECUTE FUNCTION spt.update_updated_at();
...
CREATE TRIGGER cluster_pins_update_updated_at BEFORE UPDATE ON street_smarts.cluster_pin FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();
...
CREATE TRIGGER knock_periods_update_updated_at BEFORE UPDATE ON street_smarts.knock_periods FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();

CREATE TRIGGER knocks_update_updated_at BEFORE UPDATE ON street_smarts.knocks FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();

CREATE TRIGGER outcomes_update_updated_at BEFORE UPDATE ON street_smarts.outcomes FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();
...
CREATE TRIGGER pin_ids_to_update_2024_03_25_audit_record_trigger AFTER INSERT OR DELETE OR UPDATE ON street_smarts.pin_ids_to_update_2024_03_25 FOR EACH ROW EXECUTE FUNCTION public.create_audit_record();

CREATE TRIGGER pin_ids_to_update_2024_03_25_update_updated_at BEFORE UPDATE ON street_smarts.pin_ids_to_update_2024_03_25 FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();

CREATE TRIGGER pin_notes_update_updated_at BEFORE UPDATE ON street_smarts.pin_notes FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();

CREATE TRIGGER pins_update_updated_at BEFORE UPDATE ON street_smarts.pins FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();

CREATE TRIGGER pins_update_updated_at BEFORE UPDATE ON street_smarts.pins_old FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();

CREATE TRIGGER zip_update_updated_at BEFORE UPDATE ON street_smarts.zips FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();

CREATE TRIGGER zips_update_updated_at BEFORE UPDATE ON street_smarts.zips_old FOR EACH ROW EXECUTE FUNCTION street_smarts.update_updated_at();
