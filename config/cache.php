...
return [
    ...
    */
    ...
    'default' => env(key: 'CACHE_DRIVER', default: 'redis'),
    ...
    */
    ...
    'prefix' => env(key: 'CACHE_PREFIX', default: Str::slug(title: env(key: 'APP_NAME', default: 'Payment Service'), separator: '_').'_cache_'),
