...
class PostProcessScheduledPaymentsTest extends AbstractContractTest
{
    private string $endpoint = 'api/v1/process-scheduled-payments';
    ...
    public function it_returns_202_success_and_dispatch_jobs(): void
    {
        ...
        Queue::assertPushedOn(
            ...
            job: RetrieveAreaScheduledPaymentsJob::class
        );
    }
    ...
    private function mockConfigCatClient(bool $isScheduledPaymentsProcessingEnabled = true): void
    {
        $configCatClient = $this->createMock(ClientInterface::class);

        $configCatClient->method('getValue')->willReturn($isScheduledPaymentsProcessingEnabled);
