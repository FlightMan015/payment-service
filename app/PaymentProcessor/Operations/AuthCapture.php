...
class AuthCapture extends AbstractOperation
{
    /**
     * @param GatewayInterface $gateway
     * @param string $validatorClass
     */
    public function __construct(GatewayInterface $gateway, string $validatorClass = AuthCaptureValidator::class)
    {
     ...
     * @return $this
     */
    public function process(): AuthCapture
    {
        try {
            $request = [
                ...
                'source' => $this->getToken() ?? $this->getAchToken(),
            ...
            $this->getGateway()->authCapture(inputData: $request);
     ...
     * @return $this
     */
    public function handleResponse(): AuthCapture
    {
        ...
        $this->logTransaction(transactionTypeId: TransactionTypeEnum::AUTH_CAPTURE);
